...
class DynamicRoITransRoIHeadv2_SpatialLoss(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(DynamicRoITransRoIHeadv2_SpatialLoss, self).__init__(init_cfg)
