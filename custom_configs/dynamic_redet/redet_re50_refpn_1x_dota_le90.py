...
angle_version = 'le90'
work_dir = './work_dirs/redet_re50_refpn_1x_dota_le90'
model = dict(
    type='ReDet',
    backbone=dict(
        type='ReResNet',
        ...
        frozen_stages=1,
        style='pytorch',
        pretrained='/storageStudents/nguyenvd/Luu_Thang/Luu/weight_reresnet/re_resnet50_c8_batch256-25b16846.pth'),
    neck=dict(
        type='ReFPN',
